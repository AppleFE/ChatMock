...
class ModelRegistryTests(unittest.TestCase):
    def test_normalizes_aliases(self) -> None:
        ...
        self.assertEqual(normalize_model_name("gpt5.6"), "gpt-5.6")
        self.assertEqual(normalize_model_name("gpt5.6-mini"), "gpt-5.6-mini")
    ...
    def test_allowed_efforts_follow_registry(self) -> None:
        ...
        self.assertEqual(allowed_efforts_for_model("gpt-5.6"), frozenset(("none", "low", "medium", "high", "xhigh")))
    ...
    def test_public_models_include_variants(self) -> None:
        ...
        self.assertIn("gpt-5.6-mini", model_ids)
        ...
        self.assertNotIn("gpt-5.6-mini-none", model_ids)
