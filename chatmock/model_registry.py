...
_MODEL_SPECS = (
    ...
    ModelSpec(
        ...
        aliases=("gpt5-pro",),
        allowed_efforts=DEFAULT_REASONING_EFFORTS,
        variant_efforts=("xhigh", "high", "medium", "low", "minimal"),
    ),
    ModelSpec(
    ...
    ModelSpec(
        public_id="gpt-5.5-instant",
        upstream_id="gpt-5.5-instant",
        aliases=("gpt5.5-instant", "gpt-5.5-chat"),
        allowed_efforts=frozenset(("none", "low", "medium", "high")),
        variant_efforts=("high", "medium", "low", "none"),
    ),
    ModelSpec(
        public_id="gpt-5.6",
        upstream_id="gpt-5.6",
        aliases=("gpt5.6", "gpt-5.6-latest"),
        allowed_efforts=frozenset(("none", "low", "medium", "high", "xhigh")),
        variant_efforts=("xhigh", "high", "medium", "low", "none"),
    ),
    ModelSpec(
        public_id="gpt-5.6-pro",
        upstream_id="gpt-5.6-pro",
        aliases=("gpt5.6-pro",),
        allowed_efforts=frozenset(("none", "low", "medium", "high", "xhigh")),
        variant_efforts=("xhigh", "high", "medium", "low", "none"),
    ),
    ModelSpec(
        public_id="gpt-5.6-mini",
        upstream_id="gpt-5.6-mini",
        aliases=("gpt5.6-mini",),
        allowed_efforts=frozenset(("low", "medium", "high", "xhigh")),
        variant_efforts=("xhigh", "high", "medium", "low"),
    ),
    ModelSpec(
        public_id="gpt-5.6-nano",
        upstream_id="gpt-5.6-nano",
        aliases=("gpt5.6-nano",),
        allowed_efforts=frozenset(("low", "medium", "high")),
        variant_efforts=("high", "medium", "low"),
    ),
